...
export default function CreateQuotationForm({ leads, defaultLeadId, defaultLeadName }: Props) {
  ...
  return (
    <div className="flex flex-1 flex-col min-h-screen bg-gray-50">
      <header className="flex h-14 items-center border-b px-6 gap-3 bg-white">
        ...
        <div className="bg-white rounded-xl border shadow-sm p-5 mb-6">
          <div className="flex flex-col items-end gap-1 text-sm">
            <div className="flex items-center gap-6">
              ...
              <span className="font-semibold w-32 text-right">₹{fmt(subTotal)}</span>
            </div>
            <div className="flex items-center gap-6">
              <span className="text-gray-500">Agency Fees ({agencyFeePercent}%)</span>
              <span className="font-semibold w-32 text-right">₹{fmt(agencyFees)}</span>
            </div>
            <div className="flex items-center gap-6 mt-1 pt-2 border-t w-72">
              <span className="font-bold text-gray-900 text-base">Grand Total</span>
              <span className="font-bold text-gray-900 text-xl w-32 text-right">
                ₹{fmt(grandTotal)}
              </span>
            </div>
          </div>
