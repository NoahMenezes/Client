...
export default async function LeadDetailPage({ params, searchParams }: PageProps) {
  ...
  const serializedLead = {
    ...
    budgetText: lead.budgetText || null,
    guestCount: lead.guestCount || null,
    weddingStyle: lead.weddingStyle || null,
    resortCategory: lead.resortCategory || null,
    cuisineType: lead.cuisineType || null,
    servicesLookedFor: lead.servicesLookedFor || null,
    weddingCeremonies: lead.weddingCeremonies || null,
    entertainmentOptions: lead.entertainmentOptions || null,
    hospitalityServices: lead.hospitalityServices || null,
    additionalServices: lead.additionalServices || null,
    ...
    coupleName: null,
    leadSource: contact?.source || lead.referralSource || null,
    internalNotes: '',
    basicInformation: '',
